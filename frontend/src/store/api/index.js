...
export default {
    user: {
        ...
        logout: (...args) => import(/* webpackChunkName: "user-api" */ '@/store/api/logout').then(module => module.default(...args))
    },
    workout: {
        ...
        delete: (...args) => import(/* webpackChunkName: "workout-api" */ '@/store/api/workout/delete').then(module => module.default(...args))
    },
    workoutExercise: {
        ...
        getHistory: (...args) => import(/* webpackChunkName: "workout-exercise-api" */ '@/store/api/workout-exercise/get-history.js').then(module => module.default(...args)),
        delete: (...args) => import(/* webpackChunkName: "workout-exercise-api" */ '@/store/api/workout-exercise/delete').then(module => module.default(...args))
    },
    workoutExerciseSet: {
